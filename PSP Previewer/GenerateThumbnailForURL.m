...
uint16_t TwoLittleNSDataBytesToBigUInt16(NSData* data) {
    // TODO: Make this 32-bit, just in case
...
OSStatus GenerateThumbnailForURL(void *thisInterface,
    ...
    if (!QLThumbnailRequestIsCancelled(thumbnail)) {
        ...
        if ([
            ...
            uint16_t icon0_offset = TwoLittleNSDataBytesToBigUInt16([imageData subdataWithRange:(NSRange){0x0c, 4}]);
            uint16_t icon0_offset_end = TwoLittleNSDataBytesToBigUInt16([imageData subdataWithRange:(NSRange){0x10, 4}]);
